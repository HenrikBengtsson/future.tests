make_test(.title = "futureCall() with and without lazy evaluation", lazy = c(FALSE, TRUE), .expr = {
...
make_test(.title = "futureCall()", lazy = c(FALSE, TRUE), global = c(FALSE, TRUE),  .expr = {
  a <- 3
  args <- list(x = 42, y = 12)
...
make_test(.title = 'futureCall() - globals = "a"', lazy = c(FALSE, TRUE), .expr = {
  a <- 3
  args <- list(x = 42, y = 12)
...
make_test(.title = 'futureCall() - globals = list(a = 3)', lazy = c(FALSE, TRUE), .expr = {
  a <- 3
  args <- list(x = 42, y = 12)
